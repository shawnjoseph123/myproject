                ...
                <div className="main-footer">
                    <div className="container-fluid">
                        <div className="row footer-row">
                            ...
                            <div className="col-md-4 footer-info"><i className="fa-solid fa-envelope footer-icon-small"></i><p><a href='mailto: shawnjoseph447@gmail.comProfile image
shawnjoseph447@gmail.com'>shawnjoseph447@gmail.com</a></p></div>
                    ...
                    <div className="row after-footer flex-column-reverse flex-md-row">
                        ...
                        <div className="col-md-3 after-footer-box"><img src='/Asset/shawnlogo.png' alt='Shawn Joseph'></img></div>
                    </div>
                </div>
                </div>
            </footer>
